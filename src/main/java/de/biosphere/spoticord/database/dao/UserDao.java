...
public interface UserDao {
    ...
    /**
     * Returns a map of the users with the most database entrys on a guild. 
     * The <code>code</code> argument specifies the length of the map.
     * Map contains {@link String} as Snowflake id of a user and {@link Integer} 
     * as the amount of entrys in the database.
    ...
    /**
     * Returns a map of the users with the highest listening time on a guild
     * The <code>code</code> argument specifies the length of the map.
     * Map contains {@link String} as Snowflake id of a user and {@link Integer}
     * as the amount of entrys to be returned.
     * @param guildId the Snowflake id of the guild
     * @param count the length of the map
     * @return A sorted map with <code>code</code> entrys
     */
